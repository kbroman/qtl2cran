...
makeRepo(pkgList, path="qtl2cran", repos=repos, type=c("win.binary", "mac.binary.el-capitan"), Rversion="3.6")
makeRepo(pkgList, path="qtl2cran", repos=repos, type=c("source", "win.binary", "mac.binary.el-capitan"), Rversion="4.0"))
